...
export function backgroundTextureForId(id:string){
 const map:Record<string,string>={cream:'room-background',mint:'background-serre',night:'background-night',forest:'background-forest',blossom:'background-blossom',autumn:'background-autumn'};
