...
export class PreloadScene extends Phaser.Scene{
 ...
 preload(){
  ...
  this.load.image('puzzle-board-frame','assets/ui/puzzle-board-frame.svg');
  this.load.image('puzzle-panel','assets/ui/puzzle-panel.svg');
  this.load.image('button-primary-skin','assets/ui/button-primary.svg');
  this.load.image('button-secondary-skin','assets/ui/button-secondary.svg');
  this.load.image('heart-full','assets/ui/heart-full.svg');
  this.load.image('heart-crack-1','assets/ui/heart-crack-1.svg');
  this.load.image('heart-crack-2','assets/ui/heart-crack-2.svg');
  this.load.image('heart-broken','assets/ui/heart-broken.svg');
 }
 create(){
